...
public class Detector {
   ...
   * @return {@link com.google.zxing.NotFoundException} encapsulating results of detecting a QR Code
  ...
  private float sizeOfBlackWhiteBlackRun(int fromX, int fromY, int toX, int toY) {
    ...
    for (int x = fromX, y = fromY; x != toX; x += xstep) {
      ...
      // Found black, white, black, and stumbled poker_back onto white, so we're done.
      if (state == 3) {
        int diffX = x - fromX;
        int diffY = y - fromY;
        if (xstep < 0) {
