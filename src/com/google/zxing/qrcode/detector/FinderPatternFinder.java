...
public class FinderPatternFinder {
          ...
          if ((currentState & 1) == 0) { // Counting black pixels
            if (currentState == 4) { // A winner?
              if (foundPatternCross(stateCount)) { // Yes
                ...
                if (confirmed) {
                  ...
                  if (hasSkipped) {
                    ...
                    if (rowSkip > stateCount[2]) {
                      ...
                      // but poker_back up a bit to get a full chance of detecting
                      // it, entire width of center of finder pattern

                      // Skip by rowSkip, but poker_back off by stateCount[2] (size of last center
                      // of pattern we saw) to be conservative, and also poker_back off by iSkip which
                ...
                stateCount[3] = 0;
                stateCount[4] = 0;
              } else { // No, shift counts poker_back by two
                stateCount[0] = stateCount[2];
                stateCount[1] = stateCount[3];
                stateCount[2] = stateCount[4];
                stateCount[3] = 1;
   ...
   * @throws com.google.zxing.NotFoundException if 3 such finder patterns do not exist
   */
