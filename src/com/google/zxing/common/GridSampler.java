...
public abstract class GridSampler {
   ...
   * @throws com.google.zxing.NotFoundException if image can't be sampled, for example, if the transformation defined
   ...
   *
   * <p>This method will actually "nudge" the endpoints poker_back onto the image if they are found to be
   ...
   * @throws com.google.zxing.NotFoundException if an endpoint is lies outside the image boundaries
   */
