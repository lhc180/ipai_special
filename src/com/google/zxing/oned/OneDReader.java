...
public abstract class OneDReader implements Reader {
   ...
   * @throws com.google.zxing.NotFoundException Any spontaneous errors which occur
   */
   ...
   * @throws com.google.zxing.NotFoundException if counters cannot be filled entirely from row before running out
   *  of pixels
   */
   ...
   * @return {@link com.google.zxing.Result} containing encoded string and start/end of barcode
   * @throws com.google.zxing.NotFoundException if an error occurs or barcode cannot be found
   */
