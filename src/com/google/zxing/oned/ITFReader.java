...
public final class ITFReader extends OneDReader {
   ...
   * @throws com.google.zxing.NotFoundException if decoding could not complete successfully
   */
   ...
   * zone must be at least 10 times the width of a narrow line.  Scan poker_back until
   ...
   * @throws com.google.zxing.NotFoundException if the quiet zone cannot be found, a ReaderException is thrown.
   */
   ...
   * @throws com.google.zxing.NotFoundException Throws exception if no black lines are found in the row
   */
  ...
  int[] decodeEnd(BitArray row) throws NotFoundException {
    ...
    try {
      ...
      // Put the row poker_back the right way.
      row.reverse();
    }
  }
   ...
   *         ints
   * @throws com.google.zxing.NotFoundException if pattern is not found
   */
   ...
   * @throws com.google.zxing.NotFoundException if digit cannot be decoded
   */
