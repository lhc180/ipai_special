...
public final class Decoder {
   ...
   * @throws com.google.zxing.NotFoundException if the PDF417 Code cannot be decoded
   */
  ...
  /**
   * <p>Decodes a PDF417 Code represented as a {@link com.google.zxing.common.BitMatrix}.
   * A 1 or "true" is taken to mean a black module.</p>
   *
   * @param bits booleans representing white/black PDF417 Code modules
   * @return text and bytes encoded within the PDF417 Code
   * @throws com.google.zxing.FormatException if the PDF417 Code cannot be decoded
   */
