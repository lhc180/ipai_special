...
public final class Decoder {
   ...
   * @throws com.google.zxing.FormatException if the input is not valid
   */
   ...
   * @throws com.google.zxing.FormatException if the input contains too many errors
   */
   ...
   * @throws com.google.zxing.FormatException if the matrix is not a valid aztec code
   */
